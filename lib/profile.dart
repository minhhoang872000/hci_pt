              ...
              children: [
                ...
                Column(
                  ...
                  child: Column(
                    ...
                    SizedBox(height: 10),
                    Text("Tim mạch : Không",style: TextStyle(fontSize:15),),
                    SizedBox(height: 10),
                    Text("Dị ứng các loại thực phẩm : Không",style:TextStyle(fontSize:15),),
                    SizedBox(height: 10),
                    Text("Dị ứng thời tiết : Không",style:TextStyle(fontSize:15),),
                  ],),
                ),
                ],),
                Padding(
