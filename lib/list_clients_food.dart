                       ...
                       children: [
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                SizedBox(height: 5),
                                Text("Ngày đăng ký : 25/10/2021 - 25/11/2021",style: TextStyle(color: Colors.grey)),
                                SizedBox(height: 5),
                                Text("Số lương buổi tập đã đăng ký : 15 buổi tập",style: TextStyle(color: Colors.grey)),
